...
export class Http {
  ...
  get<T = null>(path = '', options?: AxiosRequestConfig) {
    return this.client.get<T>(this.prefix + path, options);
  }

  post<T = null>(path = '', payload: any = undefined) {
    return this.client.post<T>(this.prefix + path, payload);
  }

  patch<T = null>(path = '', payload: any = undefined) {
    return this.client.patch<T>(this.prefix + path, payload);
  }

  put<T = null>(path = '', payload: any = undefined) {
    return this.client.put<T>(this.prefix + path, payload);
  }
